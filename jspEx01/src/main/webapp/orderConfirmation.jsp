			...
			<div class="py-5">
				<table class="table table-hover">
					...
					<tr>
						<td> </td>
						<td> </td>
						<td char="text-center"><strong>총액: </strong> </td>
						<td char="text-center text-danger"><strong><%=sum %></strong> </td>
					</tr>
				</table>
				<a href="./shippingInfo.jsp?cartId=<%=shipping_cartId%>" class="btn btn-secondery" role="button"> 이전 </a>
				<a href="./thankCustomer.jsp" class="btn btn-success" role="button"> 주문 완료</a>
				<a href="./checkOutCancelled.jsp" class="btn btn-secondery" role="button"> 취소 </a>
			</div>
		</div>
	</div>
</body>
