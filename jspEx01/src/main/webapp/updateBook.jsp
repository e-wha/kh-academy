...
<body>
	<div class="container py-4">
      ...
      <div class="row align-items-md-stretch">
      	<div class="col-md-5">
      		<img alt="image" src="./resources/images/<%=rs.getString("b_filename") %>" style="width: 100%" />
      	</div>
      	<div class="col-md-7">
	      	<form action="./processUpdateBook.jsp" method="post" name="newBook" enctype="multipart/form-data">
	      		<div class="mb-3 row">
	      		...
	      		<div class="mb-3 row">
	      			...
	      			<div class="col-sm-5">
	      				<textarea rows="2" cols="50" name="description" id="description" class="form-control" value="<%=rs.getString("b_description")%>" placeholder="100자 이상 적어주세요"></textarea>
	      			</div>
	      		</div>
	      		<div class="mb-3 row">
