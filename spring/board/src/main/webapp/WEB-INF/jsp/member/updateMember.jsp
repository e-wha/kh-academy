...
<sql:setDataSource var="dataSource"
	...
	driver="com.mysql.cj.jdbc.Driver" user="root" password="mysqlroot" />
 ...
 <div class="p-5 mb-4 bg-body-tertiary rounded-3">
	...
	<div class="container">
		<form name="newMember"action="/bookmarket/member/processUpdateMember.do" method="post" onsubmit="return checkForm()">
				...
				<div class="col-sm-3">
					<input name="id" type="text" class="form-control" placeholder="id" value="<c:out value='${row.id }'/>" readonly="readonly"><label>아이디는 수정할 수 없습니다.</label>
				</div>
			</div>
				<div class="mb-3 row">
